...
for filename in filenames:
    ...
    for day in range(0,sampled_length):
        ...
        for (i,j) in graph.edges:
            ...
            print(zone, day, sampled_days[zone], sampled_days[zone]['Max'])
            graph.edges[i,j][capstr] = ampacity(1.2*sampled_days[zone]['Max'].iloc[day % len(sampled_days[2]['Max'])])*graph.edges[i,j]['branch_cap']
